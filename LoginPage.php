...
if ($conn->connect_error) {
    ...
    if(isset($_POST['Submit']))
    {
        ...
        $result1 = mysqli_query($conn,"SELECT uid, password FROM user WHERE uid = '".$userid."' AND  password = '".$password."'");
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="LoginPage.php" method="post">
    ...
    <div class="container">
      ...
      <button type="Submit" name="Submit" style="border-radius: 10px; position: absolute;top:50%;left:46%">Login</button>
    </div>
  ...
  <form class="modal-content animate" action="LoginPage.php" method="post">
    ...
    <div class="container1">
      ...
      <button type="submit" name="sbmt" style="border-radius: 10px; position: absolute;top:47%;left:46%">Login</button>
    </div>
  </form>
</div>
