...
if(isset($_POST["Submit"]))
{
  ...
  if(isset($_POST["Submit10"]))
  {
    ...
    $sql = "INSERT INTO booking ( date, time, uid, movid, seats)
    VALUES ('".$_POST["date"]."','".$_POST["time"]."','".$userid."','".$mia."','".$checkBox."')";
//      echo $_POST["date"];
//      echo $_POST["time"];
//      echo $userid;
//      echo $mid;
//      echo $checkBox;
//     
//      $sql1 = "insert into booking values ('$bid','$_POST["date"]',"$_POST['time']",'$userid','$mid','$checkBox')";
//      $res = mysqli_query($conn,$sql) or die(mysqli_error($conn));
    ...
    echo '</script>';
        header("location:http://ganis-macbook-air.local/Movie/Checkout.php");
}
    else {
    echo '<script language="javascript">';    
...
</br><button type="submit" name="Submit10" class="btn btn-danger" >Submit</button>
